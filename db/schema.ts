...
// crons/sync-descriptions.ts). The dump carries only labels + statements, so
...
export const itemDescriptions = sqliteTable("item_descriptions", {
  qid: text("qid").primaryKey(), // e.g. "Q16571916"
